        ...
        <div v-if="recommendations.length" class="mt-8 space-y-4">
          ...
          <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            <router-link
              ...
              class="group block overflow-hidden rounded-2xl border border-slate-700 bg-slate-950/60 shadow-lg shadow-black/20 transition duration-200 hover:-translate-y-0.5 hover:border-emerald-400/80 hover:shadow-emerald-950/30 focus:outline-none focus:ring-2 focus:ring-emerald-400"
